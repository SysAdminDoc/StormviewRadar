(() => {
  ...
  var PALETTE_LABELS = Object.freeze({
    standard: "Standard",
    highContrast: "High contrast",
    colorblind: "Color-blind safe"
  });
  var ALERT_COLORS = Object.freeze({
  ...
  var MESH_STOPS = Object.freeze({
    standard: Object.freeze([
      [6.35, [34, 211, 238, 90]],
      [12.7, [59, 130, 246, 125]],
      [25.4, [34, 197, 94, 165]],
      [44.45, [250, 204, 21, 190]],
      [63.5, [249, 115, 22, 210]],
      [101.6, [239, 68, 68, 230]]
    ]),
    highContrast: Object.freeze([
    ...
    colorblind: Object.freeze([
      ...
      [12.7, [25, 59, 106, 135]],
      [25.4, [59, 86, 135, 165]],
      [44.45, [127, 137, 150, 195]],
      [63.5, [203, 183, 120, 220]],
      [101.6, [253, 234, 69, 240]]
    ])
  });
  var STORM_COLORS = Object.freeze({
  ...
  var LEVEL2_STOPS = Object.freeze({
    standard: Object.freeze({
  ...
  function normalizeVisualPalette(value, fallback = "standard") {
    return VISUAL_PALETTE_IDS.includes(value) ? value : VISUAL_PALETTE_IDS.includes(fallback) ? fallback : "standard";
  }
  function level2PaletteStops(product, palette = "standard") {
